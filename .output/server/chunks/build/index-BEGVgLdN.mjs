import { _ as _sfc_main$2$1, a as _sfc_main$1$1, b as _sfc_main$b } from './Menu-DZL1Uwiv.mjs';
import { useSSRContext, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, reactive } from 'vue';
...
import { _ as _sfc_main$c } from './Footer1-B2fp7HaU.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CommonMenu = _sfc_main$b;
...
//# sourceMappingURL=index-BEGVgLdN.mjs.map
