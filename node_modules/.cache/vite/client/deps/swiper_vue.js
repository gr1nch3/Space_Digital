import {
  core_default
} from "./chunk-G2QXL6MB.js";

// node_modules/swiper/vue/swiper.js
import { h as h3, ref, onMounted, onUpdated, onBeforeUnmount, watch, nextTick, provide } from "vue";
...
var Swiper = {
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      }, [slots["container-start"], h3(WrapperTag, {
        class: "swiper-wrapper"
      }, [slots["wrapper-start"], renderSlides(slides), slots["wrapper-end"]]), needsNavigation(props) && [h3("div", {
        ref: prevElRef,
        class: "swiper-button-prev"
      }), h3("div", {
        ref: nextElRef,
        class: "swiper-button-next"
      })], needsScrollbar(props) && h3("div", {
        ref: scrollbarElRef,
        class: "swiper-scrollbar"
      }), needsPagination(props) && h3("div", {
        ref: paginationElRef,
...
import { h as h4, ref as ref2, onMounted as onMounted2, onUpdated as onUpdated2, onBeforeUpdate, computed, onBeforeUnmount as onBeforeUnmount2, provide as provide2 } from "vue";
var SwiperSlide = {
  name: "SwiperSlide",
  props: {
    tag: {
  ...
  setup(props, _ref) {
    ...
    const slideElRef = ref2(null);
    const slideClasses = ref2("swiper-slide");
    ...
    provide2("swiperSlide", slideData);
    return () => {
      return h4(props.tag, {
